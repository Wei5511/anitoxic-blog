...
// Using CLOUDFRONT URLs directly from database
const assets = {
    jjk: {
...
const article = {
    ...
    category: '編輯精選',
    image_url: assets.jjk.img, // Using JJK Cloudfront URL
...
try {
    ...
    console.log('Article updated with Cloudfront images: ' + info.changes);
} catch (e) {
