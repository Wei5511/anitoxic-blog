/**
 * FIX ROMANCE PICKS V3 FINAL (Article 17)
 * 
 * Objectives:
 * 1. Consolidate ALL fixes:
 *    - Button style: Small orange, centered (no pill).
 *    - Title: "青春特調蜂蜜檸檬蘇打" (Corrected).
 *    - Images: Ensure correct download.
 * 2. Apply DIRECT LINKS found in user text files:
 *    - 相反的你和我: https://www.myvideo.net.tw/details/3/32423
 *    - 花樣少年少女: https://www.myvideo.net.tw/details/3/32406
 *    - 青春特調蜂蜜檸檬蘇打: https://www.myvideo.net.tw/details/3/29515
 *    - 輝夜姬想讓人告白: https://www.myvideo.net.tw/details/3/32347 (Special) or search if preferred.
 *    - 和山田談場Lv999的戀愛: https://www.myvideo.net.tw/details/3/23210
 *    - 堀與宮村: https://www.myvideo.net.tw/details/3/18413 (Found in context or fallback to search if not in logs, but wait, did I find it? I didn't see it in the logs above. I will check user_urls_3 just in case or keep search).
 *    - 戀上換裝娃娃: Search (Not found in logs).
 *    - 我內心的糟糕念頭: https://www.myvideo.net.tw/details/0/327702
 *    - 知道天空有多藍的人啊: Search (Not found).
 *    - 櫻蘭: Search (Not found).
 */
...
console.log('🚀 Fixing Romance Picks V3 (Applying User Links)...');
...
const romanceItems = [
    {
        ...
        url: 'https://www.myvideo.net.tw/details/3/32423', // FOUND
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/details/3/32406', // FOUND
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/details/3/29515', // FOUND
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/details/3/32347', // FOUND (Special/Season link)
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/details/3/23210', // FOUND
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/search/堀與宮村', // Still Search
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/search/戀上換裝娃娃', // Still Search
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/details/0/327702', // FOUND
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/search/天空', // Still Search
    ...
    },
    {
        ...
        url: 'https://www.myvideo.net.tw/search/櫻蘭', // Still Search
...
console.log(`✅ Updated Article 17 (V3 Final Match) with ${info.changes} change.`);
