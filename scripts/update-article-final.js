...
const images = [
    { url: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/4942/na2WQXbrJ1.jpg', name: 'jjk-s3.jpg' },
    { url: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5221/l3NdEAZAFE.jpg', name: 'party-outcast.jpg' },
    { url: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5483/lYlhTXAOnz.jpg', name: 'noble-reincarnation.jpg' },
    { url: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5483/lYlhTXAOnz.jpg', name: 'frieren-s2.jpg' }, // Same as noble? DB has it.
    { url: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5505/slfBxrWWvq.jpg', name: 'oshi-no-ko-s3.jpg' }
];

async function downloadImages() {
    for (const img of images) {
        try {
            const dest = path.join(__dirname, '..', 'public', 'images', 'anime', img.name);
...
function updateArticle() {
    const article = {
        ...
        excerpt: '除了咒術、芙莉蓮，看這兩部「開掛神作」無腦看主角開掛真的很紓壓！',
        category: '編輯精選',
        image_url: '/images/anime/party-outcast.jpg',
        myvideo_url: 'https://www.myvideo.net.tw/details/3/25276', // Party outcast main link
        content: `2026 年 1 月新番開播至今一個月，本季的陣容除了有《咒術迴戰》、《芙莉蓮》這種史詩級大作續篇之外，還有幾部「雖然低調，但看起來超級爽」的黑馬異世界番！如果你下班後不想動腦，只想看主角一路開掛、逆襲打臉，那麼這份編輯部精選的「Top 5 必看清單」絕對能滿足你的爽片需求。而且這 5 部全部都能在 MyVideo 上高清觀看！
...
[📺 點此前往 MyVideo 線上看《咒術迴戰 S3》](https://www.myvideo.net.tw/details/3/25275)


## ⚔️ 2. 被低估的逆襲爽番：泛而不精的我被逐出勇者隊伍
**完整片名：泛而不精的我被逐出了勇者隊伍～因為隊伍需要成為賦予術士的原劍士，走向萬能之路**
**製作公司：Studio A-CAT**
**推薦指數：⭐⭐⭐⭐**
**類型：奇幻 / 冒險 / 逆襲流**

![泛而不精的我被逐出勇者隊伍](/images/anime/party-outcast.jpg)
...
[📺 點此前往 MyVideo 線上看《泛而不精的我被逐出勇者隊伍》](https://www.myvideo.net.tw/details/3/25276)


## 👶 3. 出生即滿等的極致龍傲天：貴族轉生
**完整片名：貴族轉生～得天眷顧一出生就獲得最強力量～**
**製作公司：Studio Boomer**
**推薦指數：⭐⭐⭐⭐**
**類型：異世界 / 轉生 / 龍傲天**

![貴族轉生](/images/anime/noble-reincarnation.jpg)
...
[📺 點此前往 MyVideo 線上看《貴族轉生》](https://www.myvideo.net.tw/details/3/25274)
...
[📺 點此前往 MyVideo 線上看《葬送的芙莉蓮 S2》](https://www.myvideo.net.tw/details/3/32346)
...
[📺 點此前往 MyVideo 線上看《我推的孩子 S3》](https://www.myvideo.net.tw/details/3/23277)
...
以上就是本季【漫】性中毒編輯部精選的 Top 5 作品。無論是想要追求極致作畫的視覺享受，還是只想無腦看主角開掛紓壓，這份片單都能滿足你。更棒的是，這些作品全部都能在 MyVideo 上高清觀看！`
    ...
    try {
        ...
        console.log('Article inserted/updated: ' + info.changes);
    </try>catch (e) {
