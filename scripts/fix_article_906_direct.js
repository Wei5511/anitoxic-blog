...
// DEFINITIVE CLOUDFRONT URLs (Bypassing local files)
const items = [
    { t: 'Fate/strange Fake', id: '29508', img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/4942/na2WQXbrJ1.jpg', desc: '成田良悟執筆，舞台搬到美國西部。由於模仿聖杯戰爭的系統存在缺陷，召喚出了不該存在的職階與從者。「虛偽的聖杯戰爭」將帶來前所未有的戰力通膨與驚喜！\n\n這部作品與其說是聖杯戰爭，不如說是各路英雄豪傑在現代美國舞台上的極限博弈。畫面製作由 A-1 Pictures 操刀，維持了 Fate 系列一貫的高水準視覺特效。' },
    { t: '葬送的芙莉蓮 第二季', id: '32346', img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5494/a3m35gq34q.jpg', desc: '《葬送的芙莉蓮》第二季終於在萬眾矚目下歸來，正式進入原作中備受好評的「北部高原篇」。這部作品自第一季播出以來，便以其獨特的敘事節奏和對時間流逝的深刻描寫，在奇幻動畫領域佔據了一席之地。' },
    { t: '【我推的孩子】第三季', id: '23277', img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5439/k3g3d3k3.jpg', desc: '演藝圈的明爭暗鬥升級！B小町爆紅在即，阿奎亞與露比在復仇與成名的道路上越走越遠，真相即將揭曉。\n\n本季進入了原作中情感濃度最高、也是角色衝突最激烈的篇章「電影篇」。' },
    { t: '咒術迴戰 死滅迴游 前篇', id: '32428', img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5766/q7a6k8n2.jpg', desc: '隨著澀谷事變的落幕，日本社會陷入了前所未有的混亂與恐慌，而這僅僅是絕望的開始。《咒術迴戰》第三季「死滅迴游篇」以更加沉重與殘酷的基調拉開序幕。這不僅僅是另一場戰鬥，而是一場精心設計的、針對全體術師的生存遊戲。' },
...
const res = stmt.run('【MyVideo 2026 新番特輯】1月動畫強力推薦總整理（上篇）', markdown, '霸權續作回歸！這 10 部強檔沒看過，別說你懂 2026 動漫圈！', items[0].img);

console.log(`Updated Article 906. Changes: ${res.changes}`);
console.log('✅ Article 906 fixed with DIRECT Cloudfront URLs.');
