...
const assets = {
    ...
    party: {
        img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5221/l3NdEAZAFE.jpg',
        link: 'https://www.myvideo.net.tw/details/3/25276'
    },
    noble: {
        // Confirmed valid image from previous DB checks
...
🔥 領域展開！現在就去補進度
[📺 點此前往 MyVideo 線上看《咒術迴戰 S3》](${assets.jjk.link})
...
⚔️ 誰說雜魚不能翻身？看主角華麗逆襲
[📺 點此前往 MyVideo 線上看《泛而不精的我被逐出勇者隊伍》](${assets.party.link})
...
👑 一出生就無敵！體驗最極致的開掛人生
[📺 點此前往 MyVideo 線上看《貴族轉生》](${assets.noble.link})
...
✨ 再次踏上旅程，每週同步更新
[📺 點此前往 MyVideo 線上看《葬送的芙莉蓮 S2》](${assets.frieren.link})
...
🎤 謊言是愛的一種形式，真相即將大白
 [📺 點此前往 MyVideo 線上看《我推的孩子 S3》](${assets.oshi.link})
...
const article = {
    ...
    category: '編輯精選',
    image_url: assets.jjk.img, // Using JJK as cover
    myvideo_url: 'https://www.myvideo.net.tw/',
    content: content,
    published_at: null // Let default handle or now
};
...
try {
    ...
    console.log('Article inserted: ' + info.changes);
} catch (e) {
