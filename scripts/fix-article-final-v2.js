...
// Using CLOUDFRONT URLs - Updated Party Outcast from Bahamut
const assets = {
    jjk: {
        img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/4942/na2WQXbrJ1.jpg',
        link: 'https://www.myvideo.net.tw/details/3/25275'
    },
    party: {
        img: 'https://p2.bahamut.com.tw/B/2KU/08/5ba1a93d93c6f27caad0f34a1c1wayg5.JPG',
        link: 'https://www.myvideo.net.tw/details/3/25276'
    },
    noble: {
        img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/4125/O4r5kXhCg8.jpg',
        link: 'https://www.myvideo.net.tw/details/3/25274'
    },
    frieren: {
        img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5483/lYlhTXAOnz.jpg',
        link: 'https://www.myvideo.net.tw/details/3/32346'
    },
    oshi: {
        img: 'https://d28s5ztqvkii64.cloudfront.net/images/anime/5505/slfBxrWWvq.jpg',
...
<a href="${assets.jjk.link}"><img src="${assets.cta}" alt="前往MyVideo線上觀看" /></a>
...
<a href="${assets.party.link}"><img src="${assets.cta}" alt="前往MyVideo線上觀看" /></a>
...
<a href="${assets.noble.link}"><img src="${assets.cta}" alt="前往MyVideo線上觀看" /></a>
...
<a href="${assets.frieren.link}"><img src="${assets.cta}" alt="前往MyVideo線上觀看" /></a>
...
<a href="${assets.oshi.link}"><img src="${assets.cta}" alt="前往MyVideo線上觀看" /></a>
...
try {
    ...
    console.log('✅ Article updated - fixed buttons, titles, and Party image: ' + info.changes);
} catch (e) {
